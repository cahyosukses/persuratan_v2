		...
		<div class="panel panel-info">
			<div class="panel-heading">
				...
				<div class="navbar-header">
					<b class="navbar-brand"><i class="fa fa-file-o"> </i> &nbsp; Tanggapan Surat</b>
				</div>
			...
			<div class="panel-body">
				...
				<div class="col-lg-12">
					...
					<tr><td width="25%">Pemeriksa</td><td><select name="pemeriksa"</td></tr>
				...
				<div class="col-lg-12" style="margin-top: 20px">
					...
					<a href="<?=base_URL().$admin_apps?>/surat_masuk" class="btn btn-success" tabindex="4"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
				</div>
