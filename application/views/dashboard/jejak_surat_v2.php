...
<html dir="ltr" lang="id">
   ...
   <body style="margin: 0px;">
      ...
      <div class="rapidxwpr floatholder" style="width:1100px;margin:auto">
         <?php $q_instansi	= $this->db->query("SELECT * FROM instansi LIMIT 1")->row(); ?>
         <div id="header">
         	<img id="logo" class="correct-png" src="<?php echo base_url(); ?>upload/<?php echo $login_logo_header = empty($q_instansi->login_logo_header) ? "logo_login.jpg" : $q_instansi->login_logo_header; ?>" style="width:1100px;height:90px">
         </div>
         <div style="padding:10px;border: 1px solid #c6c6c6;min-height:460px" >
            <h1>Jejak Surat</h1>
            <br>
      ...
      <!--
      <div style="width:1100px;margin:0 auto;background-color:#2c6a8b;color:white;text-align:center;padding-top:10px">
